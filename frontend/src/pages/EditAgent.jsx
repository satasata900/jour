    ...
    const fetchAgent = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError('فشل في جلب بيانات الوكيل');
            }
        } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const data = await res.json();
                setError(data.detail || 'فشل في تحديث الوكيل');
            }
        } catch (err) {
            setError('فشل في الاتصال بالخادم');
        } finally {
    ...
    return (
        <DashboardLayout>
            ...
            <div className="mb-8">
                ...
                <h2 className="text-2xl font-bold text-neutral-100">تعديل الوكيل</h2>
                <p className="text-sm text-neutral-500 mt-1">تعديل إعدادات الوكيل</p>
            </div>
                ...
                <div className="rounded-2xl border border-white/5 bg-surface/30 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-neutral-500 mt-1">الوكيل سيكون جاهزاً للاستخدام</p>
                        </div>
